...
export default function JournalEntryEdit({ currentUser, setCounter, counter }) {
    ...
    fetch(`/journals/${param.id}`, {
      ...
      if (res.ok) {
        res.json().then((user) => {
          ...
          nav(`${currentUser.id}/journal/${param.id}`);
        });
      } else {
            ...
            <Grid item xs={8}>
              <Box component="form" onSubmit={handleSubmit} noValidate>
                ...
                <TextField
                  ...
                  rows={4}
                  fullWidth
                  placeholder={journalData.grateful_entry}
                  onChange={handleChange}
                ...
                <TextField
                  ...
                  placeholder={journalData.journal_entry}
                />
                {/* <ReactQuill
                name="journal_entry"
                id="quill-journal"
